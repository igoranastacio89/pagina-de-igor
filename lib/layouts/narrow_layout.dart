...
class BuildNarrowLayout extends StatelessWidget {
  const BuildNarrowLayout({Key? key}) : super(key: key);
      ...
      children: [
            ...
            AnimatedContainerTranslation(
              ...
              child: Padding(
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    launchUrl(
                        Uri.parse('https://www.instagram.com/igoranastacio/'));
                  },
                  icon: SizedBox(
                      height: 20,
                      width: 20,
        ...
        Wrap(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 8.0),
              child: Chip(label: Text('Java Script')),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 8.0),
              child: Chip(label: Text('HTML')),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 8.0),
              child: Chip(label: Text('CSS')),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 8.0),
              child: Chip(label: Text('WordPress')),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 8.0),
              child: Chip(label: Text('Pacote Office')),
            ),
          ],
        ),
        SizedBox(height: 100),
